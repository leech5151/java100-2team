...
//가능한 업무 용어를 사용한다.
//
public interface Pet_StargramService {
    List<Pet_Stargram> list(int pageNo, int pageSize, Map<String,Object> options);
    int getTotalCount();
    int add(Pet_Stargram pet_stargram);
    void addFiles(List<Pet_StargramUploadFile> files, int pet_stargramNo);
    Pet_Stargram get(int no);
    /*Pet_Stargram get(String email, String password);*/
